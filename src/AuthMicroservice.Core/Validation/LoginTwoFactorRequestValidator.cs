...
public sealed class LoginTwoFactorRequestValidator : AbstractValidator<LoginTwoFactorRequest>
{
    public LoginTwoFactorRequestValidator(IOptions<AuthMicroserviceOptions> options)
    {
